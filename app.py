...
deficiency_info = {
    ...
    "nitrogen": {
        ...
        "Marathi": {
            ...
            "लक्षणे": ["जुनी पाने पिवळी होणे", "हळू वाढ", "कमकुवत खोड"],
            "उपाय": ["युरिया वापरा", "सेंद्रिय खत वापरा"],
            "सूचना": ["माती तपासणी करा", "जास्त पाणी टाळा"]
        },
        ...
        "Telugu": {
            ...
            "లక్షణాలు": ["పాత ఆకులు పసుపు", "నెమ్మదిగా ఎదుగుదల", "బలహీనమైన కాండం"],
            "పరిష్కారం": ["యూరియా వేయండి", "సేంద్రీయ ఎరువులు వాడండి"],
            "సూచనలు": ["మట్టి పరీక్ష చేయండి", "అధిక నీరు నివారించండి"]
        }
    },
    ...
    "kalium": {
        ...
        "Marathi": {
            ...
            "लक्षणे": ["पानांच्या कडा तपकिरी", "कमकुवत खोड"],
            "उपाय": ["पोटॅश खत वापरा"],
            "सूचना": ["संतुलित खत वापरा"]
        },
        ...
        "Telugu": {
            ...
            "లక్షణాలు": ["ఆకుల అంచులు గోధుమ", "బలహీనమైన కాండం"],
            "పరిష్కారం": ["పొటాష్ ఎరువు వేయండి"],
            "సూచనలు": ["సమతుల్య ఎరువులు వాడండి"]
        }
    },
    ...
    "boron": {
        ...
        "Marathi": {
            ...
            "लक्षणे": ["वाकडी पाने", "फळांची कमी वाढ"],
            "उपाय": ["बोरॉन स्प्रे वापरा"],
            "सूचना": ["जास्त पाणी टाळा"]
        },
        ...
        "Telugu": {
            ...
            "లక్షణాలు": ["వంకర ఆకులు", "పండ్ల ఎదుగుదల తగ్గుతుంది"],
            "పరిష్కారం": ["బోరాన్ స్ప్రే చేయండి"],
            "సూచనలు": ["అధిక నీరు ఇవ్వవద్దు"]
        }
    },
    ...
    "mg": {
        ...
        "Marathi": {
            ...
            "लक्षणे": ["शिरांमध्ये पिवळेपणा", "पाने वाकणे"],
            "उपाय": ["मॅग्नेशियम सल्फेट वापरा"],
            "सूचना": ["मातीचा pH सांभाळा"]
        },

        "Telugu": {
            "పేరు": "మెగ్నీషియం లోపం",
            "వివరణ": [
            ...
            "లక్షణాలు": ["శిరల మధ్య పసుపు", "ఆకులు ముడుచుకోవడం"],
            "పరిష్కారం": ["మెగ్నీషియం సల్ఫేట్ వేయండి"],
            "సూచనలు": ["మట్టి pH సరిచూడండి"]
        }
    },
    ...
    "healthy": {
        ...
        "Marathi": {
            ...
            "लक्षणे": ["हिरवी पाने", "सामान्य वाढ"],
            "उपाय": ["काही गरज नाही"],
            "सूचना": ["चांगली काळजी घ्या"]
        },

        "Telugu": {
            "పేరు": "ఆరోగ్యకరమైన ఆకు",
            "వివరణ": [
                "ఆకులు పచ్చగా ఉంటాయి",
                "మొక్క ఎదుగుదల సాధారణంగా ఉంటుంది",
                "ఏ లోపం ఉండదు"
            ],
            "లక్షణాలు": ["పచ్చని ఆకులు", "సాధారణ ఎదుగుదల"],
            "పరిష్కారం": ["ఏ చర్య అవసరం లేదు"],
            "సూచనలు": ["మంచి సంరక్షణ కొనసాగించండి"]
        }
    }
}
# -------------------------------
